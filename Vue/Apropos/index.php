...
<ul>
    ...
    <li>On y retrouve un lien pour créer un nouvel article (seulement par un auteur dans une prochaine version) :</li>
    <ul>
        <li>La page de création d'un article offre de spécifier le sujet traité par
            l'article (type) par autocomplétion.<br>
        </li>
        <li>L'article peut être modifié (seulement par son auteur dans une prochaine version).<br>
        </li>
    ...
    <ul>
        ...
        <li>Les commentaires peuvent (seulement par l'auteur dans une prochaine version) :</li>
        <ul>
